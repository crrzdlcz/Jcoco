...
public class Gramatica implements GramaticaConstants {
  ...
  static final public void Declaracion_Variable() throws ParseException {
    jj_consume_token(declaracionVariable);
    ...
    jj_consume_token(operadorAsignacion);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case numeroEntero:{
    ...
    case numeroFlotante:{
      jj_consume_token(numeroFlotante);
      break;
      }
    case cadenadeCaracteres:{
      jj_consume_token(cadenadeCaracteres);
      break;
      }
    case identificador:{
      jj_consume_token(identificador);
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x3e0,0x0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x100,0x0,0x78000,};
	}
